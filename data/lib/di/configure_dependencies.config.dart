...
import 'package:data/repositories/product_repository_impl.dart' as _i956;
...
import '../sources/local/preference_manager/preference_manager_impl.dart';
...
_i174.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i498.ProductRepository>(
      () => _i956.ProductRepositoryImpl(gh<_i980.ProductRemoteDataSource>()));
  return getIt;
}
