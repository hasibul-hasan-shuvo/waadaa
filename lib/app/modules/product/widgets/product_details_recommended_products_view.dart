...
class ProductDetailsRecommendedProductsView extends ObservableView<
    ProductViewModel, ProductState, List<ProductUiModel>> {
  const ProductDetailsRecommendedProductsView({super.key});
        ...
        ? Column(
            ...
            children: [
              ...
              ProductDetailsSuggestedProductListView(
                title: context.localizations.titleJustForYou,
                subTitle: context.localizations.subtitleJustForYou,
                products: state,
                viewAllPressed: () {
